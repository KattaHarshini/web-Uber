document.addEventListener('DOMContentLoaded', () => {
  ...
  {
  "question": "Design a data structure that supports insert, delete, getRandom in O(1) time.",
  "description": "Tests understanding of hash maps and lists.",
  "hint": "Use a HashMap and ArrayList together.",
  "answer": `
...
},
{
  ...
  "description": "Tests priority queue and heap concepts.",
...
},
{
  ...
  "description": "Checks knowledge of data structures like LinkedHashMap.",
  "hint": "Use LinkedHashMap to maintain insertion order.",
  "answer": `
    <p><strong>Sample Answer (Java):</strong></p>
    <pre><code class="language-java">class LRUCache extends LinkedHashMap&lt;Integer, Integer&gt; {
...
},
{
  ...
  "description": "Tests sliding window and hashmap usage.",
  "hint": "Expand and contract a sliding window, track counts with maps.",
  "answer": `
    <p><strong>Sample Answer (Java):</strong></p>
    ...
    int left = 0, minLen = Integer.MAX_VALUE, start = 0, count = 0;
...
},
{
  ...
  "description": "Checks understanding of DFS and recursion stack.",
  "hint": "Use DFS with a visited and recursion stack array.",
  "answer": `
    <p><strong>Sample Answer (Java):</strong></p>
    <pre><code class="language-java">public boolean hasCycle(int V, List&lt;List&lt;Integer&gt;&gt; adj) {
